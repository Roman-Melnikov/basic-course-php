...
$firstTime = readline("Сколько примерно времени эта задача займет?\n");/*лучше задать этот, повторяющийся,
вопрос какой-то переменной $query = "Сколько примерно времени эта задача займет?\n"*/
...
/*вывод лучше было сделать разными echo или, хотя бы, в коде разбить на строки*/
/*также вывод хорошо было сделать в html*/